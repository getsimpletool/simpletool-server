...
from server.services.sse_transport import SseTransport
from server.routers.admin import get_mcpserver_service
...
async def invoke_tool(
    ...
    result = await server_manager.invoke_tool(tool_name, params)
...
# Export the router for access from parent module
__all__ = ['router', 'get_sse_transport']
